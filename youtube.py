...
# Api key connection
def Api_connect():
    Api_Id = "AIzaSyCDHQRBj3qS6lXyIDl3EQDMrcqxqtS-Xyc"
...
with st.sidebar:
    ...
    st.caption(":red[In this project involved with below technologies are covered......]")
    st.caption("1. Youtube API v3")
    st.caption("2. Python Scripting")
    st.caption("3. MySql")
    st.caption("4. Data Collections")
    st.caption("5. Data management by MySql")

#channel_id=st.text_input("Enter the Channel ID")

if st.button(":red[Transform to sql]"):   
    Tables = tables()
    st.success(Tables)
